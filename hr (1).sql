...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 21, 2026 at 05:29 AM
...
INSERT INTO `employee` (`eid`, `fname`, `lname`, `sex`, `branchID`) VALUES
(1, 'Sardy', 'Nash', 'male', 2),
(2, 'Corny', 'Toe', 'female', 1);
...
--
ALTER TABLE `employee`
  ADD CONSTRAINT `employee_ibfk_1` FOREIGN KEY (`branchID`) REFERENCES `branch` (`bid`) ON DELETE NO ACTION ON UPDATE CASCADE;
COMMIT;
